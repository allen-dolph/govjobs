...
public class TestProvider extends AndroidTestCase  {
    ...
    public void testGetType() {
        // content://com.allendolph.android.govjobs/job
        String type = mContext.getContentResolver().getType(JobEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.inglass.sunshine/job
        assertEquals(JobEntry.CONTENT_TYPE, type);
